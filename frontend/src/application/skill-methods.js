export const SKILL_METHODS = {
    woodcutting: {
        label: "Woodcutting",
        methods: [
            { key: "regular_trees", name: "Regular Trees", xpPerAction: 25, actionLabel: "log", itemYields: [{ item: "normal_logs", quantity: 1 }] },
            { key: "oak_trees", name: "Oak Trees", xpPerAction: 37.5, actionLabel: "log", itemYields: [{ item: "oak_logs", quantity: 1 }] },
            { key: "willow_trees", name: "Willow Trees", xpPerAction: 67.5, actionLabel: "log", itemYields: [{ item: "willow_logs", quantity: 1 }] },
            { key: "maple_trees", name: "Maple Trees", xpPerAction: 100, actionLabel: "log", itemYields: [{ item: "maple_logs", quantity: 1 }] },
            { key: "yew_trees", name: "Yew Trees", xpPerAction: 175, actionLabel: "log", itemYields: [{ item: "yew_logs", quantity: 1 }] },
        ],
    },
    firemaking: {
        label: "Firemaking",
